...
It's time to make sure everything is working properly. Download [this file](https://hc.instructure.com/courses/16327/files/3676957/download?download_frd=1) and "knit" it. The first PDF you create with RMarkdown might take some time. Afterward, it will run much faster.
